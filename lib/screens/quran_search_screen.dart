  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, isDark, _) {
        return Scaffold(
          backgroundColor: isDark ? const Color(0xFF2A2A2A) : const Color(0xFFF5ECD7),
          appBar: AppBar(
            backgroundColor: isDark ? const Color(0xFF1A1A2E) : const Color(0xFF8B6914),
            elevation: 0,
            centerTitle: true,
            title: Text(
          ...
          body: Column(
            children: [
              Container(
                color: isDark ? const Color(0xFF1A1A2E) : const Color(0xFF8B6914),
